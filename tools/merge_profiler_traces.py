...
def merge_traces(input_dir, output_file):
    ...
    for file_path in trace_files:
        ...
        try:
            ...
            if not distributed_info or "rank" not in distributed_info:
                ...
                print(
                    f"Warning: File {file_path} lacks 'distributedInfo' or 'rank' field. Skipping this file."
                )
                continue
            ...
            if rank_id is None or rank_id < 0:
                print(
                    f"Warning: Invalid rank_id ({rank_id}) in file {file_path}. Skipping this file."
                )
                continue
            ...
            if not events:
                print(
                    f"  Warning: Rank {rank_id} file contains no 'traceEvents'. Skipping this file."
                )
                continue
            ...
            meta_event = {
                ...
                "args": {"name": f"Rank {rank_id}"},  # The name displayed in the UI
            }
    ...
    final_trace = {"traceEvents": all_events, "displayTimeUnit": final_display_unit}

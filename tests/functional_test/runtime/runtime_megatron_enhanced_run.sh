...
export CP_INTRANODE_BACKEND=${CP_INTRANODE_BACKEND:-nvshmem}
export CP_INTERNODE_BACKEND=${CP_INTERNODE_BACKEND:-torch_dist}
export EP_INTRANODE_BACKEND=${EP_INTRANODE_BACKEND:-deepep}
...
echo "[runtime-debug] GPUS_PER_NODE=${GPUS_PER_NODE} WORLD_SIZE=${WORLD_SIZE} MASTER_ADDR=${MASTER_ADDR} MASTER_PORT=${MASTER_PORT}"

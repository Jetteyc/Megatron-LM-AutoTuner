...
nsys profile "${NSYS_ARGS[@]}" python -m tests.custom.${KERNEL_NAME}.${KERNEL_NAME} --num_runs 1
...
ncu ${NCU_ARGS[@]} python -m tests.custom.${KERNEL_NAME}.${KERNEL_NAME} --num_runs 1
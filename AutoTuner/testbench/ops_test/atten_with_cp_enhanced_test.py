...
class TestAttnFuncWithCPAndKVP2PNVSHMEM(TestWithHiddenInputs):
    def __init__(
        self,
        ...
        self.module_name = "AttnFuncWithCPAndKVP2PNVSHMEM"
        ...
        if profile_mode == ProfileMode.collect_data:
            with MemoryTrackerContext(
                "AttnFuncWithCPAndKVP2PNVSHMEM init"
            ) as memory_tracker_ctx:
                self.op = AttnFuncWithCPAndKVP2PNVSHMEMForTest(
                    tf_config,
